...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _1801967_archive_1.so
_1801967_archive_1.so : archive.247/_1801967_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic $(LD_NORELAX_FLAG)  -o .//../simv.daidir//_1801967_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_1801967_archive_1.so $@


ARCHIVE_OBJS += _prev_archive_1.so
_prev_archive_1.so : archive.247/_prev_archive_1.a
	@$(AR) -s $<
